    ...
    >
      ...
      <div className="container mx-auto p-8 text-justify bg-accent/10 rounded-md">
        <div className="flex xl:flex-row flex-col">
          ...
          <h1 className="text-2xl xl:text-right text-center">با طراحی گرافیکی حرفه‌ای، کسب‌وکار خود را به تصویر بکشید
</h1>
        <br />
        <p>در دنیای امروز، طراحی گرافیک نقش بسیار مهمی در موفقیت هر کسب‌وکاری ایفا می‌کند.
</p>
          </div>
          <div className="xl:w-[20%] w-full flex justify-center">
            <img src="/images/Graphics1-technoraspberry.png" alt="" className="w-[100px] h-[100px]" />
          </div>
        </div>
      </div>
      <div className="container mx-auto p-8 text-justify bg-[#00FF9C]/20 rounded-md">
        ...
        <br />
        <div className="grid grid-cols-2 xl:gap-20 gap-8">
          <div><h3 className="font-bold">جذب مشتریان جدید<span>:</span></h3><p>طراحی‌های گرافیکی جذاب و خلاقانه می‌توانند توجه مشتریان بالقوه را جلب کرده و آن‌ها را به سمت محصولات یا خدمات شما هدایت کنند.</p></div>
          <div><h3 className="font-bold">ارتباط مؤثر با مخاطبان<span>:</span></h3><p>با استفاده از طراحی گرافیکی، می‌توانید پیام خود را به صورت واضح و جذاب به مخاطبان منتقل کنید.</p></div>
          <div><h3 className="font-bold">افزایش فروش<span>:</span></h3><p>طراحی‌های گرافیکی حرفه‌ای می‌توانند به شما کمک کنند تا محصولات یا خدمات خود را به صورت جذاب‌تری به نمایش بگذارید و در نتیجه فروش خود را افزایش دهید.</p></div>
      ...
      <br />
      <div className="flex xl:flex-row flex-col">
        <div><h3 className="font-bold">تیم خلاق و حرفه‌ای<span>:</span></h3><p>تیم طراحی ما با ایده‌های نوآورانه و خلاقانه، طراحی‌های منحصر به فردی را برای شما خلق می‌کند.</p>
        <br />
        ...
        <br />
        <h3 className="font-bold">توجه به نیازهای مشتری<span>:</span></h3><p>ما با در نظر گرفتن نیازها و سلیقه‌های شما، طرح‌های مورد نظر شما را طراحی می‌کنیم.</p></div>
        <div>
          <img src="/images/Graphics2-technoraspberry.png" alt="" className="w-[400px] h-[400px] xl:pr-10 pr-0"/>
        </div>
      </div>
      </div>
      <div className="container mx-auto p-8 bg-[#00FF9C] rounded-md text-center">
        ...
        <Button
              ...
              >
                <a href="/iot"><span>خدمات سخت‌افزار</span></a>
        </Button>
        <Button
                variant="outline"
