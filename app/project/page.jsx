  ...
  return <motion.section
    ...
    >
      <div className="container mx-auto">
        ...
        <p className="container mx-auto text-3xl text-center xl:mt-20 mt-10 font-bold text-accent xl:leading-[2rem] leading-[3rem]">فرم ثبت پروژه در ادامه قابل مشاهده است !!</p>
        {/* form */}
            <form
